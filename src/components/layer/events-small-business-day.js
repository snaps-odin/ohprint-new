...
class EventsCheerUp extends React.Component {
  constructor(...args) {
    super(...args);
  ...
  onSubmit(values) {
    ...
    let params = {
      ...
      'attribute09': values[ 'userSns' ] || "",
      'attribute10': values[ 'userCompany' ] || "",
      'bbsContents': values[ 'contents' ]
    };

    let couponNumber = '12745A24-996A-187D';
                  ...
                  <tr>
                    ...
                    <td>
                      <Field name="userSns"
                             ...
                             width={246}
                             maxLength={95}
                             placeholder="사업장 블로그, 인스타 등 (선택)"
                             component={InputField}/>
                    </td>
                  </tr>
                  <tr>
                    <th  className={"caption"} colSpan={"2"}>홍보물 제작이 필요한 사장님의 이야기를 들려주세요.</th>
                  </tr>
                  <tr>
                    <td colSpan="2">
                      <Field name="contents"
                             className="box cheerupEvent"
                      ...
                      <div className={"subCaption"}>
                        *최종으로 선정된 사장님의 이야기는 별도의 인터뷰 진행 및 블로그 컨텐츠로 재활용 될 수 있습니다. (추후 협의 예정)
                      </div>
                    </td>
                  </tr>
                  </tbody>
