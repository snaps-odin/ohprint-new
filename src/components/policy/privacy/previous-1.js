...
export default class PrivacyPrevious0 extends React.Component {
	constructor(...args) {
		super(...args);
		...
		return (
			<div className="policy-contents-wrap">
				<div className="section">
					㈜스냅스 오프린트미(이하 ‘회사’)는 개인정보보호 관련 주요 법률인 개인정보보호법, 정보 통신망 이용 촉진 및 정보 보호 등에 관한 법률 (이하 “정보 통신망 법”이라고 합니다)을 비롯한 모든
					개인정보보호 관련 법률 규정 및 관련 국가기관 등이 제정한 고시, 훈령, 지침 등을 준수합니다.
				</div>

				{showNavigate && (
					<div className="section">
						본 개인정보취급방침의 목차는 아래와 같습니다.
					</div>
				)}
				...
				{showNavigate && (
					<div className="info-list">
						<ol>
							<li>
								<span>1. </span><a data-index={1} onClick={this.onClickFocus}>개인정보취급방침의 의의</a>
							</li>
							<li>
				...
				<h3 id="section-1">제1조 (개인정보취급방침의 의의)</h3>
				<div className="section">
					㈜스냅스 오프린트미 (이하 ‘회사’)는 개인정보취급방침을 통하여 회사가 제공하는 온라인 서비스인 오프린트미 서비스를 이용하는 회원의 개인정보보호를 소중하게 생각하고, 회원의 개인정보를 보호하기
				...
				<div className="section">
					<span>2) 수집 방법</span>
					<span>∙ 오프린트미 홈페이지를 통한 회원 가입, 배송 요청, 경품 행사 응모과정에서 해당 개인정보를 수집합니다.</span>
					<span>∙ 고객센터를 통한 상담과정에서 웹페이지, 메일, 팩스, 전화 등을 통해 이용자의 개인정보가 수집될 수 있습니다.</span>
				</div>
				...
				<div className="section">
					<span>2) 회원 관리</span>
					<span>- 회원제 서비스 이용에 따른 본인확인 , 개인 식별 , 불량회원의 부정 이용 방지와 비인가 사용 방지 , 연령확인 , 만14세 미만 아동 개인정보 수집 시 법정 대리인 동의여부 확인 , 불만처리 등 민원처리 , 고지사항 전달 </span>
				</div>
				<div className="section">
				...
				<div className="section">
					...
					<span><i/>불량 이용자 재가입 방지, 부정 이용 방지, 기타 민원 대응 </span>
					<span>- 보유 기간 : 회원 탈퇴 후 6개월 간 (단, 민원 대응의 경우 민원 해결 시까지) </span>
					<span>- 보유 정보 : 아이디, 이메일, 가입일, 탈퇴일  </span>
				</div>
				<div className="section">
				...
				<div className="section">
					회사는 정보 통신망 법 관련 조항에 따라 가입 후 1년(이하 “개인정보 유효 기간”이라고 합니다) 동안 서비스를 이용한 사실 또는 활동한 기록이 없는 경우, 개인정보의 안전한 보호 및 피해
					발생을 방지하기 위해 ‘정보 통신망 이용 촉진 및 정보 보호 등에 관한 법률 제 29조’ 에 근거하여 이용자에게 사전 통지하고 개인정보를 별도로 분리하여 저장 관리합니다. 회사는 유효 기간이
					도래하기 30일 전까지 이메일, 문자메시지, 휴대전화 등 회원이 입력한 연락 수단을 통하여 사전 통지합니다. 다만 개인정보 유효 기간이 도래한 회원의 경우에도 회원이 별도 유효 기간 갱신의 요청
					등 개별 동의가 있는 경우, 머니가 남아있는 경우 또는 타 법령에서 별도로 보존 기간을 정하는 경우에는 관련 법령이 정한 기간 동안 보존 후 조치 됩니다. 개인정보 유효 기간제에 의해 별도
					분리된 경우라도 회원이 서비스 재이용을 원하실 경우 본인 확인 절차를 거쳐 서비스를 재이용하실 수 있습니다.
				</div>
				<div className="section">
					5) 파기 절차
				</div>
				...
				<h3 id="section-5">제5조 (개인정보 제3자 동의)</h3>
				<div className="section">
				...
				<div className="section">
					...
					<span>- 보유 기간 및 보유 정보 : 회원의 요청 또는 동의를 얻은 항목, 기간에 한하여 해당 기간 동안 보유 </span>
					<span>2. 법령의 규정에 의거하거나, 수사 목적으로 법령에 정해진 절차와 방법에 따라 수사기관의 요구가 있는 경우 </span>
				</div>
				<h3 className="line" id="section-6">제6조. (개인정보 취급 위탁)</h3>
				<table border="0">
					<caption><span className="blind">제6조. (개인정보 취급 위탁)</span></caption>
					<colgroup>
						<col style={{ width: '50%' }}/>
						<col style={{ width: '50%' }}/>
					</colgroup>
					...
					<tr>
						<td>KG이니시스, 카카오페이, 케이페이, NHN엔터테인먼트</td>
				...
				<h3 id="section-7">제7조 (이용자 및 법정 대리인의 권리와 행사방법)</h3>
				<div className="section">
					<span>1) 이용자 및 법정 대리인은 언제든지 등록되어 있는 자신 혹은 당해 만 14세 미만 아동의 개인정보를 조회하거나 수정할 수 있으며 가입해지를 요청할 수도 있습니다.  </span>
				...
				<table border="0" className="bg">
					...
					<tr>
						<td>
							<strong>개인정보관리 담당부서</strong><br/>
							이용자서비스담당부서 : CS 센터<br/>
							전화번호 : 1577-4703<br/>
							이메일 : <a href="mailto:ohprintme@ohprint.me" style={{ textDecoration: 'underline' }}>
							ohprintme@ohprint.me</a>
						</td>
						<td>
							<strong>개인정보관리 책임자</strong><br/>
							개인정보관리책임자 성명 : 박윤혁<br/>
							전화번호 : 1577-4703<br/>
							이메일 : <a href="mailto:chandler@snaps.com" style={{ textDecoration: 'underline' }}> chandler@snaps.com</a>
						</td>
					</tr>
					</tbody>
				</table>
				...
				<div className="section">
					본 개인정보취급방침의 내용 추가, 삭제 및 수정이 있을 경우 개정 최소 7일 전에 ‘공지사항’을 통해 사전 공지할 것입니다. 다만, 수집하는 개인정보의 항목, 이용목적의 변경 등과 같이 이용자
					권리의 중대한 변경이 발생할 때에는 최소 30일 전에 홈페이지 또는 이메일을 통해 사전 공지합니다, 필요 시 이용자 동의를 다시 받을 수 있습니다.
				</div>
				<div className="section">
					<strong>공고일자 | 2018년 03월26일</strong><br/>
					<strong>시행일자 | 2018년 04월02일</strong>
				</div>
			</div>
		)
	}
