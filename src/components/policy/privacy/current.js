	...
	render() {
		...
		return (
			<div className="policy-contents-wrap">
				<div className="section">
					㈜위블링 오프린트미(이하 ‘회사’)는 개인정보보호 관련 주요 법률인 개인정보보호법, 정보통신망 이용촉진 및 정보보호 등에 관한 법률 (이하 "정보통신망법"이라고 합니다)을 비롯한 모든
				...
				<div className="section">
					㈜위블링 오프린트미 (이하 ‘회사’)는 개인정보처리방침을 통하여 회사가 제공하는 온라인 서비스인 오프린트미 서비스를 이용하는 회원의 개인정보보호를 소중하게 생각하고, 회원의 개인정보를 보호하기
        ...
        <table border="0">
          ...
          <tr>
            <td>구글</td>
            <td>미국</td>
            <td>Google analytics 서비스의 이용<br/>Google ads 마케팅 업무 (맞춤형 광고 제공)</td>
            <td>광고식별정보 및 쿠키 정보, IP주소<br/>(일부 마스킹 처리된 범위)</td>
            <td>서비스이용 시점에 네트워크를 통한 전송</td>
          ...
          <span><i/>3.Google은 쿠키 정보의 분석을 위하여 개인식별 가능성이 없는 ‘쿠키’ 정보를 미국 내 Google 서버로 전송합니다. Google의 정보 처리에 관한 보다 자세한 내용은 www.google.com/analytics/learn/privacy.html을 참고하시기 바랍니다.</span>
              ...
              연락처 : 070-7420-0158, privacyinfo@snaps.com
				...
				<div className="section">
					<strong>공고일자 | 2022년 12월 09일</strong><br/>
					<strong>시행일자 | 2022년 12월 19일</strong>
				</div>
			</div>
		)
	}
