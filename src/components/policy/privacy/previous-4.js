	...
	render() {
		...
		return (
			<div className="policy-contents-wrap">
				...
				<table border="0" className="bg">
					...
					<tr>
						...
						<td>
							...
							개인정보관리책임자 성명 : 조기연<br/>
							전화번호 : 1577-4703<br/>
							이메일 : <a href="mailto:marvin@snaps.com" style={{ textDecoration: 'underline' }}> marvin@snaps.com</a>
						</td>
					</tr>
					</tbody>
				</table>
				...
				<div className="section">
					<strong>공고일자 | 2019년 10월 15일</strong><br/>
					<strong>시행일자 | 2019년 10월 22일</strong>
				</div>
			</div>
		)
	}
