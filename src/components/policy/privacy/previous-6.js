	...
	render() {
		...
		return (
			<div className="policy-contents-wrap">
				...
				<div className="section">
					<span>2) 수집 방법</span>
					<span>∙ 오프린트미 홈페이지를 통한 회원 가입, 배송 요청, 경품 행사 응모과정에서 이용자가 직접 입력한 개인정보를 수집합니다</span>
        ...
        <table border="0">
          ...
          <span><i/>3.Google은 쿠키 정보의 분석을 위하여 개인식별 가능성이 없는 ‘쿠키’ 정보를 미국 내 Google 서버로 전송합니다. Google의 정보 처리에 관한 보다 자세한 내용은 www.google.com/analytics/learn/privacy.html을 참고하시기 바랍니다.</span>
              ...
              개인정보 보호책임자 : 개인정보보호센터장<br/>
              관련업무 담당부서 : 개인정보보호센터<br/>
              전화번호 : 070-7420-0158<br/>
              문의처  : privacyinfo@ohprint.me
						</td>
					</tr>
					</tbody>
				</table>
				...
				<div className="section">
					<strong>공고일자 | 2020년 4월 29일</strong><br/>
					<strong>시행일자 | 2020년 5월 06일</strong>
				</div>
			</div>
		)
	}
