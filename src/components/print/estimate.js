...
class Estimate extends React.Component {
  constructor(...args) {
    ...
    this.printType = "ESTIMATE";
  }

  componentDidMount() {
    let { actions, orderCode, projectCodes } = this.props;

    console.log(this.props);

    actions[`handleRequest${orderCode ? "OrderHistoryTaxByOrderCode" : "CartEstimate"}`](orderCode || projectCodes, this.printType)
      .then((result) => {
